...
class AddressBook:
	def __init__(self, win):
		...
		self.searchInp = Entry(self.AddressbookFrame, textvariable=self.searchVal ,width=30).place(x=10, y=50)

		#searchIcon = PhotoImage(file="images/search.png")
		#searchIconImg = searchIcon.subsample(1, 1)
		self.searchBtn = Button(self.AddressbookFrame, text="Search", command=self.search).place(x=195, y=48)
